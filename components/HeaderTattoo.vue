    ...
    <header>
        <div class="full">
            ...
            <div class="logo-container">
                ...
                <div class="logo-subname">TATTOO STUDIO</div>
            </div>
            <div class="nav-container">
                <NuxtLink to="/">{{ texts["header-navbar-contacto"] }}</NuxtLink>
                <img src="/img/reservar_tatto.svg" alt="">
                <div class="language">
        ...
        <div class="mobile">
            ...
            <div class="nav">
                <div class="hamburger">
                    <img class="open-icon" src="/img/hamburger_tattoo.svg" alt="hamburger">
                    <img class="close-icon" src="/img/x_tattoo.svg" alt="x" style="display: none;">
                </div>
...
<script setup>
    ...
    onMounted(async () => {
        ...
        const menu = mobile.querySelector(".menu");
        const hamburger = mobile.querySelector(".hamburger");
        const open_icon =  mobile.querySelector(".open-icon");
        const close_icon =  mobile.querySelector(".close-icon");
        const language = mobile.querySelector(".language");
        const logo = mobile.querySelector(".logo-container");
